    ...
    foreach ($offers as $offer) {
        ...
        <a href="/offres/<?php echo $offer["id"]; ?>">
            <div>
                ...
                <div class="home-card">
                    <div class="image">
                        <img src="<?php echo htmlspecialchars($offer["image"]); ?>" alt="Image de <?php echo htmlspecialchars($title); ?>">
                    </div>
                    ...
                    <div class="cardContent">
                        ...
                        <div class="enLigne">
                            <p class="par">Par</p>
                            <p class="name"><?php echo htmlspecialchars($offer["author"]); ?></p>
                        </div>

                        <div class="enLigneGap">
                            <p><?php echo htmlspecialchars($offer["type"]); ?></p>
                            <div class="enLigne">
                                ...
                                <p><?php echo htmlspecialchars($offer["location"]); ?></p>
                            </div>
                        </div>

                        <div class="summary">
                            <p><?php echo htmlspecialchars($offer["summary"]); ?></p>
                        </div>
                        ...
                        <div class="opposeLigne">
                            <div class="enLigne">
                                <p>Il y a</p>
                                <p><?php echo htmlspecialchars($offer["dateSincePublication"]); ?></p>
                                <p>j</p>
                            </div>

                            <div class="price">
                                <?php if (!empty($offer["price"])): ?>
                                    <p class="price-text"><?php echo htmlspecialchars($offer["price"]); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
