    ...
    <div class="header-content">
        ...
        <x-input rounded class="lg:w-[600px] sm:w-full">
            <input slot="input" type="text" placeholder="Recherchez des activités, visites, spectacles..."
                title="Rechercher" id="searchBar">
            <button slot="button" class="button only-icon sm" id="searchButton" title="Valider la recherche">
...
<section>
    <div class="home-display">
        ...
        <div class="carousel-gen" data-slides-visible="3" data-slides-to-scroll="1">
            ...
            <div class="home-card">
                <a href="/offres/<?php echo $offer["id"]; ?>" title="voir l'offre <?php echo $offer['title']; ?>">
                    <!-- Image -->
                    ...
                    <div class="card-content">
                        ...
                        <div class="flex flex-col gap-2">
                            <!-- Type + Professional -->
                            <p class="text-sm"><?php echo $offer["type"]; ?> proposé par <a href="/"
                                    title="accèder au profil de <?php echo $offer["author"]; ?>"><?php echo $offer["author"]; ?></a>
                            </p>
...
<section>
    <div class="home-display mt-12 mb-12">
        ...
        <div class="carousel-gen" data-slides-visible="3" data-slides-to-scroll="1">
            ...
            <div class="home-card">
                <a href="/offres/<?php echo $offer['id']; ?>" title="accès à l'offre <?php echo $offer['title']; ?>">
                    <!-- Image -->
                    <div class="image-container">
                        <img src="<?php echo $offer["image"]; ?>" alt="Image de <?php echo $offer['title']; ?>">
                        <!-- Nice background on hover -->
