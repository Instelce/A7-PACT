        ...
        if (Data.length === 0 && offset === 0) {
            ...
            Data.forEach((offer) => {
                ...
                <p>${translateCategory(offer.category)} par <a href="/comptes/${offer.professional_id
                        ...
                        ${offer.minimum_price ? "<div> À partir de " + offer.minimum_price + " € </div >" : "<div class='hidden'></div>"}
                        ${offer.status ? "<div>" + offer.status + "</div >" : "<div class='hidden'></div>"}
                        ${offer.address.city ? "<div>" + offer.address.city + "</div>" : "<div class='hidden'></div>"}
                        </div >
                        </div >
                    <div class="flex gap-2 mt-auto pt-4">
                        ...
                        <a href="/offres/${offer.id}" class="button blue w-full spaced">Voir plus<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right"><path d="m9 18 6-6-6-6" /></svg></a>
                    </div>
            </article >
                    `;
