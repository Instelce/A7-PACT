...
export function createOpinionCard(opinion, dashboard = false) {
...
`;
    ...
    if(opinion.offer.type==="premium"){
        blacklistButton = card.querySelector(".blacklist-card");
        blacklistSvg = blacklistButton.querySelector('svg');
    }

    if (blacklistButton && blacklistSvg && blacklistButton !== null && blacklistSvg !== null){
