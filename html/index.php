...
$app->router->get('/mentions', [SiteController::class, 'mentions']);
...
$app->router->get('/dashboard/notifications', [DashboardController::class, 'notificationRead']);
...
$app->router->post('/comptes/otp-login', [AuthController::class, 'otpLogin']);
$app->router->get('/comptes/otp-login', [AuthController::class, 'otpLogin']);
